/** biome-ignore-all lint/suspicious/noExplicitAny: ai-elements */
...
export const PromptInput = ({
  ...
  const matchesAccept = useCallback(
    (f: File) => {
      ...
      // Split accept string and check against each pattern
      ...
      for (const pattern of acceptPatterns) {
        ...
        // Check file extension (e.g., ".pdf")
          ...
          if (f.name.toLowerCase().endsWith(pattern.toLowerCase())) {
            return true
          }
        }
      }
