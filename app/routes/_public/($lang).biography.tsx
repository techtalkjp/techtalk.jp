...
import { BiographyHero } from './+($lang).biography/components/BiographyHero'
import { BiographyNavigation } from './+($lang).biography/components/BiographyNavigation'
import { CareerTimeline } from './+($lang).biography/components/CareerTimeline'
import { MediaCoverage } from './+($lang).biography/components/MediaCoverage'
import { SocialLinks } from './+($lang).biography/components/SocialLinks'
